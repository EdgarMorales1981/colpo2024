...
export default function MisPost() {
    ...
    const enviar = async (e) => {
        ...
        try {
            ...
            alert('UserId enviado');
        } catch (error) {
            alert('Error al enviar el post', error.message);
        }
    };
    ...
    return (
        <>
            ...
            <div className={styles.container}>
                ...
                <textarea value={post} onChange={verificar} className={styles.textarea} />
                <div className={styles.inputGroup}>
                    <input onChange={verificar2} type="file" id="imagen" className={styles.input} required />
                </div>
                    <button disabled={post===null || file === null}  onClick={enviar} className={styles.button}>Enviar</button>
